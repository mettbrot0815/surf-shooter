...
<reference>
@/home/user/test/surf-shooter/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/test/surf-shooter/.claude/get-shit-done/references/user-profiling.md` to load:
