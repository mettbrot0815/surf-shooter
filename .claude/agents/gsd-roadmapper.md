...
Reference full template: `/home/user/test/surf-shooter/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/test/surf-shooter/.claude/get-shit-done/templates/state.md`.
