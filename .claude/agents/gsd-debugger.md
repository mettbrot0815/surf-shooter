...
<required_reading>
@/home/user/test/surf-shooter/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/test/surf-shooter/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/test/surf-shooter/.claude
                  → checks /home/user/test/surf-shooter/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/test/surf-shooter/.claude/get-shit-done
                  → writes to /home/user/test/surf-shooter/.claude/get-shit-done/hooks/
...
@/home/user/test/surf-shooter/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/test/surf-shooter/.claude/get-shit-done/references/common-bug-patterns.md
