...
Use template from `/home/user/test/surf-shooter/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/test/surf-shooter/.claude/get-shit-done/templates/UI-SPEC.md`
