...
```markdown
Read /home/user/test/surf-shooter/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/test/surf-shooter/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/test/surf-shooter/.claude/agents/gsd-ui-checker.md for instructions.
