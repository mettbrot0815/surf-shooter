...
```
Task(
  prompt="Read /home/user/test/surf-shooter/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/test/surf-shooter/.claude/get-shit-done/templates/VALIDATION.md`
